<template>
  <div class="v-right-item">
    ...
    <button
      ...
      aria-hidden="true"
      :title="`${dWords.tl_navigation_on} (F8)`"
    ...
    <button
      ...
      aria-hidden="true"
      :title="`${dWords.tl_navigation_off} (F8)`"
      @click="$clicks('navigation')"
    />
    <button
      v-if="toolbars.preview"
      v-show="sPreviewSwitch"
      type="button"
      class="op-icon fa fa-mavon-eye-slash selected"
      aria-hidden="true"
      :title="`${dWords.tl_edit} (F9)`"
    ...
    <button
      ...
      aria-hidden="true"
      :class="{'selected': sSubfield}"
      :title="`${sSubfield ? dWords.tl_single_column : dWords.tl_double_column} (F12)`"
